...
rem NOTE: The -m navigation marker has been removed to run ALL tests.
echo docker run --rm -v "%ARTIFACT_PATH%\allure-results":/app/allure-results %IMAGE_NAME% pytest --alluredir=allure-results
...
rem *** ADDED: Force immediate exit after launching the server to stop recursion ***
EXIT
